...
int main()
{
    ...
    check(-2, 18.0f, 9.9f, 30.0f, 11.0f, 10.0f, 16.0f);
    check(-1, 19.0f, 10.45f, 30.0f, 11.0f, 10.0f, 16.0f);
    check(0, 20.0f, 11.0f, 30.0f, 11.0f, 10.0f, 16.0f);
    check(1, 21.0f, 11.55f, 30.0f, 11.0f, 10.0f, 16.0f);
    check(2, 22.0f, 12.1f, 30.0f, 11.0f, 10.0f, 16.0f);
