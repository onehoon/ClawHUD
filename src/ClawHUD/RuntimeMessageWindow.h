...
// Owns the runtime-only hidden Win32 message window: WM_POWERBROADCAST
// suspend/resume notifications, the production WM_TIMER stream and the
// runtime-control dispatch / shutdown-ready wakes. It is deliberately
// independent of TrayIcon so Managed mode keeps runtime infrastructure alive
// without a tray.
//
